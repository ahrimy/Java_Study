...
public class Find_Panel extends JPanel implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == back_main) {
			...
			if (id == "") {
				JOptionPane.showMessageDialog(null, "존재하지 않는 회원입니다.", "아이디 찾기", JOptionPane.WARNING_MESSAGE);
			}
			else {
				JOptionPane.showMessageDialog(null, "아이디 : " + id_pw_tf.getText()+ "\n비밀번호 : "+id, "비밀번호찾기", JOptionPane.WARNING_MESSAGE);
			}
		}
	}
